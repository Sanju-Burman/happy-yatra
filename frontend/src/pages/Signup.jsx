    ...
    <div data-testid="signup-page" className="min-h-screen flex items-center justify-center px-6 py-20">
      ...
      >
        <div className="bg-card rounded-2xl shadow-lg p-8 md:p-12 border border-border">
          <h1 className="font-heading text-4xl font-bold text-foreground mb-2 tracking-tight">Create Account</h1>
          <p className="text-muted-foreground mb-8">Start your personalized travel journey</p>
          ...
          <form onSubmit={handleSubmit} data-testid="signup-form" className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground/70 mt-1">Minimum 6 characters</p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground">
              ...
              <Link to="/login" data-testid="signup-login-link" className="text-primary hover:opacity-80 font-medium">
                Login
              </Link>
            </p>
          </div>
