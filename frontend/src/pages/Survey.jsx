    ...
    switch (step) {
      case 1:
        return (
          ...
          >
            <h2 className="font-heading text-3xl font-bold text-foreground mb-3">What are your interests?</h2>
      ...
      case 2:
        return (
          ...
          >
            <h2 className="font-heading text-3xl font-bold text-foreground mb-3">What's your budget?</h2>
            <p className="text-muted-foreground mb-8">Choose your preferred budget level</p>
      ...
      case 3:
        return (
          ...
          >
            <h2 className="font-heading text-3xl font-bold text-foreground mb-3">How do you travel?</h2>
            <p className="text-muted-foreground mb-8">Select your travel style</p>
            <div className="space-y-4">
      ...
      case 4:
        return (
          ...
          >
            <h2 className="font-heading text-3xl font-bold text-foreground mb-3">Where have you been?</h2>
            <p className="text-muted-foreground mb-8">Select regions you've visited</p>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-medium text-muted-foreground">{Math.round((step / totalSteps) * 100)}%</span>
          </div>
        ...
        {/* Step Content */}
        <div className="bg-card rounded-2xl shadow-lg p-8 md:p-12 mb-8 border border-border">
        ...
        <div className="flex justify-between gap-4">
          {step > 1 && (
            <button
              ...
              className="bg-transparent border border-border text-foreground rounded-full px-8 py-3 hover:bg-accent transition-all duration-300 flex items-center gap-2 font-medium"
            >
