    ...
    <div data-testid="landing-page" className="relative">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-[#F9F8F6]"></div>
        </div>
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-secondary mb-4 tracking-tight">Why Choose WanderGuide</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">Intelligent recommendations tailored just for you</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-[#F2EFE9] p-8 rounded-xl border border-transparent hover:border-primary/20 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <h2 className="font-heading text-4xl md:text-5xl font-bold text-secondary tracking-tight">Trending Destinations</h2>
            </div>
          </motion.div>
