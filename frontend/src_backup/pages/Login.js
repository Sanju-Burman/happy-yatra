    ...
    <div data-testid="login-page" className="min-h-screen flex items-center justify-center px-6 py-20">
      ...
      >
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <h1 className="font-heading text-4xl font-bold text-secondary mb-2 tracking-tight">Welcome Back</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/signup" data-testid="login-signup-link" className="text-primary hover:text-[#A04B32] font-medium">
                Sign up
              </Link>
            </p>
          </div>
