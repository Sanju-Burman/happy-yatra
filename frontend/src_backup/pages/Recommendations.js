    ...
    return (
      <div data-testid="recommendations-loading" className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">Generating your personalized recommendations...</p>
        </div>
      </div>
    );
  }
    ...
    <div data-testid="recommendations-page" className="min-h-screen px-6 md:px-12 lg:px-24 py-20">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-secondary mb-4 tracking-tight">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-heading text-2xl font-semibold text-secondary">Map View</h2>
          </div>
        ...
        {/* Destinations Grid */}
        <div className="mb-8">
          <h2 className="font-heading text-2xl font-semibold text-secondary mb-6">All Recommendations</h2>
          {destinations.length === 0 ? (
            <p className="text-gray-600 text-center py-12">No recommendations found. Please try updating your survey.</p>
          ) : (
