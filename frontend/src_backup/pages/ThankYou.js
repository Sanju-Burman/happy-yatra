        ...
        <div className="bg-white rounded-2xl shadow-lg p-12 md:p-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              className="bg-transparent border border-secondary text-secondary rounded-full px-8 py-3 hover:bg-secondary hover:text-white transition-all duration-300 font-medium"
            >
              Back to Home
            </button>
          </div>
